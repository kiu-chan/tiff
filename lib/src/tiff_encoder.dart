...
class TiffEncoder {
  ...
  static Uint8List encode(List<TiffImageSpec> pages, {bool? bigTiff, Endian endian = Endian.little}) {
    return TiffWriter.write(pages: pages, forceBigTiff: bigTiff, endian: endian);
  }
}
